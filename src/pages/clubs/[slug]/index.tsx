...
import { CalendarDays, Globe, Instagram, Linkedin, Mail, MapPin, Share2, Trophy, Users } from 'lucide-react';
    ...
    <ClubsLayout>
      <main className='min-h-screen bg-background pb-12'>
        ...
        <div className='relative h-[300px] md:h-[400px]'>
          <img src={club?.coverImage} alt={club?.name} className='object-cover' />
