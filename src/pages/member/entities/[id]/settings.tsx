        ...
        <TabsContent value="general">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your entity's basic settings and preferences
              </CardDescription>
            </CardHeader>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Let users request to join this entity
                    </p>
                  </div>
        ...
        <TabsContent value="permissions">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure what members can do in this entity
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Let members create announcements
                    </p>
                  </div>
        ...
        <TabsContent value="notifications">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure how you want to be notified about entity activities
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Archive this entity and all its content
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">
                      Permanently delete this entity and all its content
                    </p>
                  </div>
