      ...
      <div className='container mx-auto px-4 py-8 space-y-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          {stats.map((stat, index) => (
            <MotionCard key={stat.title} delay={index * 0.1} className='bg-card hover:shadow-lg transition-shadow'>
        ...
        <AnimatePresence>
          ...
          >
            {organizations.map((organization: Organization, index: number) => (
              ...
              >
                <div className='p-2'>
                  <p className='text-sm text-muted-foreground line-clamp-2 min-h-[40px]'>{organization.description}</p>
                </div>
              </MotionCard>
            ))}
          </motion.div>
          ...
          >
            ...
            <div className='space-y-6'>
              ...
              <div className='flex justify-end gap-4 pt-4 border-t'>
                <Button variant='outline' onClick={() => setIsCreateModalOpen(false)} className='w-[100px]'>
                  Cancel
                </Button>
                <Button
                ...
                <div>
                  ...
                  <div className='grid grid-cols-2 gap-2 mt-2'>
                    {selectedInstitute.departments.map(dept => (
                      <div key={dept.id} className='p-2 bg-muted rounded-md text-sm'>
                        {dept.name}
                      </div>
                    ))}
                  </div>
