...
import { UPDATE_SUPER_ADMIN_PROFILE, UPDATE_SUPER_ADMIN_PASSWORD, UPDATE_SUPER_ADMIN_SETTINGS } from '@/graphql/mutations';
...
const SuperAdminSettings = () => {
  ...
  const [updatePassword, { loading: updatingPassword }] = useMutation(UPDATE_SUPER_ADMIN_PASSWORD, {
    onCompleted: (data) => {
