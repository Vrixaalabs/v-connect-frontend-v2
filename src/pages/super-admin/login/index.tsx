      ...
      >
        <Card className='p-8'>
          <div className='flex flex-col items-center mb-8'>
            ...
            <p className='text-muted-foreground text-center mt-2'>Secure login for system administrators</p>
          </div>
            ...
            {step === 'credentials' ? (
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className='space-y-4'>
                <div className='text-center mb-6'>
                  ...
                  <p className='text-sm text-muted-foreground mt-2'>A 6-digit code has been sent to {formData.email}</p>
                </div>
