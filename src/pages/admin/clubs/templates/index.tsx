  ...
  return (
    <div className='space-y-8'>
      <div>
        ...
        <p className='text-muted-foreground mt-2'>Choose and customize your club page template</p>
      </div>
        ...
        <TabsContent value='templates' className='space-y-6'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {templates.map(template => (
              <Card key={template.id} className={selectedTemplate === template.id ? 'ring-2 ring-primary' : ''}>
                <CardHeader className='p-0'>
                  <div className='relative h-48 w-full'>
                    <img src={template.image} alt={template.name} className='object-cover rounded-t-lg' />
                  </div>
                </CardHeader>
          ...
          <Card>
            ...
            <CardContent className='space-y-6'>
              <div className='space-y-2'>
                ...
                <textarea placeholder='Enter a detailed description about your club...' className='min-h-[100px]' />
              </div>
              <div className='space-y-2'>
                <Label>Mission Statement</Label>
                <textarea placeholder="What is your club's mission?" className='min-h-[100px]' />
              </div>
              <div className='space-y-2'>
