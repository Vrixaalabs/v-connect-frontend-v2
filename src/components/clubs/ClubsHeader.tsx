  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground mt-2'>Discover and join clubs that match your interests</p>
      </div>

      <div className='flex flex-col sm:flex-row gap-4'>
        <div className='relative flex-1'>
          <Search className='absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground' />
          <Input placeholder='Search clubs by name, category, or description...' className='pl-9' />
        </div>
          ...
          <Sheet>
            ...
            <SheetContent>
              <SheetHeader>
                ...
                <SheetDescription>Refine your club search with additional filters</SheetDescription>
              </SheetHeader>
