          ...
          <CardContent className='p-6'>
            <div className='flex items-start gap-6'>
              <div className='relative h-24 w-24 rounded-lg overflow-hidden flex-shrink-0'>
                <img src={achievement.image} alt={achievement.title} className='object-cover' />
              </div>
              <div className='flex-1 min-w-0'>
                ...
                <p className='text-sm text-muted-foreground'>{format(new Date(achievement.date), 'MMMM d, yyyy')}</p>
              </div>
            </div>
          </CardContent>
        </Card>
