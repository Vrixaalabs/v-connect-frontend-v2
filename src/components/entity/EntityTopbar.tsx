...
import { Building2, Users, Calendar, Settings, ChevronLeft, Bell, MoreVertical } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function EntityTopbar() {
  ...
  const currentTab = tabs.find(tab => location.pathname === `/member/entities/${id}${tab.href}`);
          ...
          <div className='flex items-center gap-2'>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align='end'>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className='text-red-600'>Archive Entity</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        </div>
